Rails.application.routes.draw do
  ...
  resources :artists do
    ...
    # get '/songs/:artist_id/:song_id', to: 'songs#show', as: 'artist_song' # saving these for after the project review since i don't want to use restful urls
    # get '/artists/:artist_id', to: 'artists#show', as: 'artist' # same as above
  end
  ...
  namespace :party do
    get '/:username/playlist', to: 'hosts#index'
